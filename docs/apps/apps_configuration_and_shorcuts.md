...
| Hardware monitoring         | ✅ HWiNFO                                                           | —                                                      | ✅ CoolerControl + OpenRGB + nvtop + rivalcfg | → [§8.1](#81-hwinfo-windows-vs-hardware-monitoring-cachyos)                                                                                                                                                                                                                      |
| Keychron Launcher           | ✅                                                                  | ✅                                                     | ✅                                            | → [§8.2](#82-keychron-launcher-all-platforms) · browser-based (WebHID), no install                                                                                                                                                                                               |
| Multi-monitor management    | ✅ DisplayFusion (paid)                                             | ✅ native (AeroSpace workspaces)                       | ✅ native (Hyprland workspaces)               | → [§8.3](#83-multi-monitor-displayfusion-windows-only--paid)                                                                                                                                                                                                                     |
...
| Gaming                      | Steam, Epic, GeForce Experience, Ubisoft Connect, Oculus, SideQuest | —                                                      | Steam                                         | → packages.yaml                                                                                                                                                                                                                                                                  |
| Cloud drives                | Google Drive, OneDrive, iCloud                                      | Google Drive                                           | —                                             | → packages.yaml                                                                                                                                                                                                                                                                  |
...
| Devices software            | Logitech G HUB, Brother iPrintScan, SteelSeries GG, MSI Center      | —                                                      | rivalcfg (paru)                               | → packages.yaml                                                                                                                                                                                                                                                                  |
...
| Notes / text editors (other) | Notion, PDFgear                                                    | Notion                                                 | —                                              | → packages.yaml · Obsidian has its own row above                                                                                                                                                                                                                                 |
| Dev tools (other)           | VS Code, Docker Desktop, ComfyUI Desktop, MongoDB Compass, Make     | Docker Desktop, ComfyUI                                | claude-code, docker + docker-compose, meson, neovim | → packages.yaml                                                                                                                                                                                                                                                             |
